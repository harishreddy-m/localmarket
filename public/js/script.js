	...
	$("#workPage, #logo").click(function()
		{
			if(!isWorkCurrentPage)
			{
				...
				isAboutCurrentPage = false;isLoginCurrentPage=false;
				$("#workPage").attr("class", "currentPage");
				$("#aboutPage,#loginPage").removeClass("currentPage");
				
				$("#about,#login").fadeOut(500, function()
				{
					$("#work").fadeIn(500);
				});
			}
	...
	$("#aboutPage").click(function()
		{
			if(!isAboutCurrentPage)
			{
				...
				isWorkCurrentPage = false;isLoginCurrentPage=false;
				$("#aboutPage").attr("class", "currentPage");
				$("#workPage,#loginPage").removeClass("currentPage");
				
				$("#work,#login").fadeOut(500, function()
				{
					$("#about").fadeIn(500);
				});
			}
	...
	$("#loginPage").click(function()
		{
			if(!isLoginCurrentPage)
			{
				...
				isLoginCurrentPage = true;
				$("#loginPage").attr("class", "currentPage");
				$("#workPage,#aboutPage").removeClass("currentPage");
				
				$("#work,#about").fadeOut(500, function()
				{
					$("#login").fadeIn(500);
				});
			}
